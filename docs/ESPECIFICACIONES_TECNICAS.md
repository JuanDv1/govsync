...
| `vigencia` debe estar entre 2000 y 2100 (D18, `docs/DECISIONES.md`)                                                                                                                                                | —, hallazgo del QA manual (2026-09-23)                                                                                                                                                                     | Dominio: `Corte.validar_vigencia`                                                                          |
...
| Vigencia fuera de rango (D18)                              | `422`  | `ReglaDeNegocioViolada` (`detalles.motivo == "vigencia_fuera_de_rango"`)                                    |
